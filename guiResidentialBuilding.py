...
def residentialBuildingWindow(rootWindow, screenWidth, screenHeight): 
    ...
    def calculationButton():
        if len(residentialBuildingObjects) > 0:
            ...
            residentialBuildingObjectValue["buildingClassTxt"]                     = i.buildingClass()
            residentialBuildingObjectValue["flowRateTxt"]                          = i.flowRateCalculation()
            residentialBuildingObjectValue["fireHydrantPointsNmbTxt"]              = i.fireHydrantPointsCalculation()
            residentialBuildingObjectValue["fireHydrantPointsDistanceTxt"]         = i.distanceFireHydrantPoints()
            residentialBuildingObjectValue["fireHydrantPointsEntranceDistanceTxt"] = i.distanceFireHydrantEntrance()
    ...
    ### Row 3 ###
    buildingStageNmbLabelFrame = ttk.Frame(residentialBuildingWindow)
    buildingStageNmbLabelFrame.grid(row = 3, column = 0)
    
    stageNmbLabel = ttk.Label(buildingStageNmbLabelFrame, text = "Number of stages [-]", font = ("TkDefaultFont", 12, "bold"), foreground = hydrogainBlue)
    stageNmbLabel.grid(row = 0, column = 0)
    stageNmbLegendLabel = ttk.Label(buildingStageNmbLabelFrame, text = "Ground floor = 0", font = ("TkDefaultFont", 8, "italic"), foreground = hydrogainBlue)
    stageNmbLegendLabel.grid(row = 1, column = 0)
    ...
    ### Row 4 ###
    buildingHeightLabelFrame = ttk.Frame(residentialBuildingWindow)
    buildingHeightLabelFrame.grid(row = 4, column = 0)
    ...
    ### Row 5 ###
    buildingStairsDistanceLabelFrame = ttk.Frame(residentialBuildingWindow)
    buildingStairsDistanceLabelFrame.grid(row = 5, column = 0)
    
    buildingStairsDistanceLabel = ttk.Label(buildingStairsDistanceLabelFrame, text = "Stairs distance [m]", font = ("TkDefaultFont", 12, "bold"), foreground = hydrogainBlue)
    buildingStairsDistanceLabel.grid(row = 0, column = 0)
    buildingStairsDistanceLegendLabel = ttk.Label(buildingStairsDistanceLabelFrame, text = "Distance from the staircase to the housing", font = ("TkDefaultFont", 8, "italic"), foreground = hydrogainBlue)
    buildingStairsDistanceLegendLabel.grid(row = 1, column = 0)
    ...
    buildingLadderTruckFrame = ttk.Frame(residentialBuildingWindow)
    buildingLadderTruckFrame.grid(row = 6, column = 1)
    
    buildingLadderTruckAccessVar = tk.BooleanVar()
    buildingLadderTruckAccessVar.set(True)
    buildingLadderTruckAccessRadioTrue  = ttk.Radiobutton(buildingLadderTruckFrame, text = "True", variable = buildingLadderTruckAccessVar, value = True)
    buildingLadderTruckAccessRadioFalse = ttk.Radiobutton(buildingLadderTruckFrame, text = "False", variable = buildingLadderTruckAccessVar, value = False)
    ...
    calculationFrame.rowconfigure(11, weight = 1)
    calculationFrame.rowconfigure(12, weight = 1)
    
    calculationFrame.columnconfigure(0, weight = 1)
    calculationFrame.columnconfigure(1, weight = 5)
    ...
    resultsLabel.grid(row = 0, column = 0, columnspan = 2, padx = 30, pady = 10)   
    ...
    flowRateValue.grid(row = 4, column = 0, sticky = "w")
    ...
    fireHydrantPointsNmbLabel.grid(row = 5, column = 0, sticky = "w")
    ...
    fireHydrantPointsNmbValue.grid(row = 6, column = 0, sticky = "w")
    ...
    fireHydrantPointsDistanceLabel.grid(row = 7, column = 0, sticky = "w")
    ...
    fireHydrantPointsDistanceValue.grid(row = 8, column = 0, sticky = "w")
    ...
    fireHydrantPointsEntranceDistanceLabel.grid(row = 9, column = 0, sticky = "w")
    ...
    fireHydrantPointsEntranceDistanceValue.grid(row = 10, column = 0, sticky = "w")
    ...
    minimalDurationLabel.grid(row = 11, column = 0, sticky = "w")
    ...
    minimalDurationValue.grid(row = 12, column = 0, sticky = "w")
